...
public final class PreDrawBlurController implements BlurController {
    ...
    public boolean draw(Canvas canvas) {
        ...
        if (canvas instanceof BlurCanvas) {
            return false;
        }
    ...
    @Override
    public BlurFacade setFrameClearDrawable(@Nullable Drawable frameClearDrawable) {
    ...
    public BlurFacade setBlurAutoUpdate(final boolean enabled) {
